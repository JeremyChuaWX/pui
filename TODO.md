...
3. [ ] focus should be trapped in prompt box
4. [ ] allow for highlighting and copying to clipboard, but should not be auto-copied, still required cmd-c
5. [ ] remove cost from subagent statusline
