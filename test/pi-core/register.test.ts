...
import { BUNDLED_EXTENSION_FACTORIES, createBundledExtensionFactories } from "#pi-core/register.js";
        ...
        try {
            const loader = new DefaultResourceLoader({
                ...
                additionalExtensionPaths: [
                    fileURLToPath(new URL("../../src/modules/subagents/interfaces/pi.ts", import.meta.url)),
                ],
                noSkills: true,
